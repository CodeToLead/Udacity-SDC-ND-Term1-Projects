'''Helper class responsible for detecting lane lines in a single frame/image. Requires a CalibrateCamera and
TransformPerspective object to process each image/frame. Uses a ThresholdBinary to create a binary
...
from ThresholdBinary import ThresholdBinary
...
class FindLane:
    ...
    def process_image(self, image, diag=False):
        ...
        image_thres = ThresholdBinary(image_undst).threshold_image()
